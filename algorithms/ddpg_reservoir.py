...
class DDPG_Reservoir(object):
    ...
    def update(self, replay_buffer, reservoir_buffer=None, batch_size=32):
        # Sample replay buffer
        if reservoir_buffer is not None:
            x1, y1, u1, r1, d1 = reservoir_buffer.sample(batch_size//2)
            x, y, u, r, d = replay_buffer.sample(batch_size//2)
